...
FREECODECAMP = (
    ...
    '\n'
    'These two require serialized pickles or it will fail\n'
    ...
    '\n'
    'These last two will help validate whether the program works.\n'
    '7. Run the testing suite\n'
    '8. A playground to manually test through the data (opens the pickle)\n'
    '\n'
    'Typing anything else will quit the program\n'
)
